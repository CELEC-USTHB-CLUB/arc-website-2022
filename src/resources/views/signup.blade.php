      ...
      <div class="forms-container">
        <div class="signin-signup">
          <div  class="form sign-in-form">
            ...
            <div class="input-field">
              <i class="fas fa-phone"></i>
              <input value="{{ old('from') }}" name="from" type="text" placeholder="Vous êtes de quelle wilaya?"/>
            </div>
            <div class="input-field">
              <i class="fa fa-graduation-cap"></i>
              <input value="{{ old('study_level_1') }}" name="study_level_1" type="text" placeholder="Niveau d'étude et spécialité" />
            </div>
            <select name="wilaya">
            ...
            <div class="input-field">
              <i class="fa fa-graduation-cap"></i>
              <input value="{{ old('study_level_2') }}" name="study_level_2" type="text" placeholder="Niveau d'étude et spécialité" />
            </div>
          ...
          <div class="form sign-up-form">
            ...
            <div class="input-field">
              <i class="fa fa-graduation-cap"></i>
              <input value="{{ old('study_level_3') }}" name="study_level_3" type="text" placeholder="Niveau d'étude et spécialité" />
            </div>
            <div class="input-field">
              <i class="fas fa-user"></i>
            ...
            <div class="input-field">
              <i class="fa fa-graduation-cap"></i>
              <input value="{{ old('study_level_4') }}" name="study_level_4" type="text" placeholder="Niveau d'étude et spécialité" />
            </div>
